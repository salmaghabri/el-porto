    ...
    <>
      <div className="flex flex-col md:flex-row gap-5 justify-center px-16 py-16 min-h-screen">
        <div className="socials w-full md:w-1/2 px-6 border-2 text-cherry border-cherry ">
          ...
          <h3 className="text-lg  mb-6 font-Vioda font-medium">
        ...
        <div className="form w-full md:w-2/3 p-8  shadow-lg rounded-lg font-Vioda ">
          <form onSubmit={handleSubmit} className="space-y-6  ">
            ...
            <div className="mb-4">
              <textarea
                ...
                className="w-full px-3 py-2  focus:outline-none font-serif text-xl bg-transparent placeholder-cherry placeholder-opacity-80 placeholder:font-medium placeholder:font-Vioda "
                rows="6"
            ...
            <div className="flex gap-1 items-center font-medium ">
              ...
              <input
                ...
                onChange={handleChange}
                className="w-1/2 px-3 py-2  focus:outline-none font-serif text-xl bg-transparent placeholder-cherry placeholder-opacity-80 placeholder:font-medium placeholder:font-Vioda "
