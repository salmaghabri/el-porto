export const projects = [
  ...
  {
    name: "Semantic Segmentation of Hyperspectral Images",
    description: [
      "Implemented a UNet model architecture to classify various land cover classes in Indian Pines dataset.",
      "Implemented a UNet model architecture to classify various land cover classes in Indian Pines dataset.",
      "Implemented a UNet model architecture to classify various land cover classes in Indian Pines dataset.",
    ],
  ...
  {
    name: "Data Integration Application",
    description: [
      "Engineered a streamlined implementation of a database synchronization mechanism",
    ],
    tools: ["RabbitMQ", " Tkinter"],
    links: {
      github: "https://github.com/username/car-sales-analysis",
      kaggle: "https://www.kaggle.com/username/car-sales-analysis",
    },
